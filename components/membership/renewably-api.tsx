...
export default function RenewablyApi() {
  return (
    <section className='bg-[#D9E5FB]'>
      <div className='mx-4 md:mx-6 lg:mx-24 xl:mx-45 px-2 md:px-4 py-8 md:py-12'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-10 items-stretch'>
          ...
          <div className='w-full h-full flex justify-center items-center'>
            <Image
              src='/membership/api-blueprint.png'
              alt='API blueprint'
              width={533}
              height={486}
              quality={100}
              sizes='(max-width: 1023px) 88vw, 520px'
              className='w-full max-w-150 max-h-110 h-auto rounded-[19px] object-contain'
            />
          </div>
        </div>
      </div>
